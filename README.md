...
Example List
------------
RetwisJ - A Java, Spring Data port of [Retwis](http://redis.io/topics/twitter-clone). Documentation available [here](http://static.springsource.org/spring-data/data-keyvalue/examples/retwisj/current/). [Live instance](http://retwisj.cloudfoundry.com/) available on [CloudFoundry](http://www.cloudfoundry.com/) (see getting started [guide](http://blog.springsource.com/2011/04/27/getting-started-redis-spring-cloud-foundry/) )
